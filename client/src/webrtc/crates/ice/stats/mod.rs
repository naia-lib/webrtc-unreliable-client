...
pub(crate) struct CandidatePairStats {
    ...
    pub(crate) remote_candidate_id: String,
    ...
    pub(crate) last_packet_sent_timestamp: Instant,
    ...
    pub(crate) last_packet_received_timestamp: Instant,
    ...
    pub(crate) first_request_timestamp: Instant,
    ...
    pub(crate) last_request_timestamp: Instant,
    ...
    pub(crate) last_response_timestamp: Instant,
    ...
    pub(crate) current_round_trip_time: f64,
    ...
    pub(crate) available_incoming_bitrate: f64,
    ...
    pub(crate) circuit_breaker_trigger_count: u32,
    ...
    pub(crate) retransmissions_received: u64,
    ...
    pub(crate) consent_expired_timestamp: Instant,
}
